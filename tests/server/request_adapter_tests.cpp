...
TEST(RequestAdapterTest, IcarusProtocol) {
    ...
    EXPECT_EQ(getOrderIdFromGui(GUI_FIELD::HOPPER_ETH_MAIN).order_id, CMD_ID::HOPPER_CMD_MAIN_FUEL);
    EXPECT_EQ(getOrderIdFromGui(GUI_FIELD::HOPPER_N2O_MAIN).order_id, CMD_ID::HOPPER_CMD_MAIN_N2O);
